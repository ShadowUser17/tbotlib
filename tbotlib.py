...
class Request:
    ...
    def __getslice__(self, start, end):
        return self.__data[slice(start, end)]


    def __delslice__(self, start, end):
        del self.__data[slice(start, end)]
...
class BotWorker:
    ...
    def __setitem__(self, cmd, handler):
        self.__cmd[cmd] = handler
